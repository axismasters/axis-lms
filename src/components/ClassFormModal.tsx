    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-xl modal-enter">
          ...
          {TABS.map(tab => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.key ? 'border-indigo-600' : 'border-transparent'
              )}
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {form.fee > 0 && (
                      <span className="text-sm font-semibold" style={{ color: 'oklch(0.511 0.262 276.966)' }}>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    {form.fee > 0 && (
                      <>
                        ...
                        <div className="font-semibold" style={{ color: 'oklch(0.511 0.262 276.966)' }}>
        ...
        <DialogFooter className="gap-2">
          ...
          <Button size="sm" onClick={handleSubmit} className="h-8 text-xs" style={{ background: 'oklch(0.511 0.262 276.966)' }}>
            {isEdit ? '수정 저장' : '반 개설'}
          </Button>
        </DialogFooter>
      </DialogContent>
