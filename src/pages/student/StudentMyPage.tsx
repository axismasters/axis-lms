      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <div className="axis-card p-5">
          <div className="flex items-center gap-2 mb-3">
            <Swords size={16} style={{ color: 'oklch(0.511 0.262 276.966)' }} />
          ...
          {!editingNick ? (
            ...
            <div className="space-y-2">
              <input
                ...
                style={{ border: `1px solid ${nickError ? 'oklch(0.577 0.245 27.325)' : 'oklch(0.511 0.262 276.966)'}`, color: 'oklch(0.2 0.02 250)' }}
              />
              {nickError && (
        ...
        <div className="axis-card p-4">
          ...
          <div className="space-y-2">
            {[
              ...
              { icon: Trophy, label: '성장 진열장', path: '/student/growth', color: 'oklch(0.511 0.262 276.966)' },
