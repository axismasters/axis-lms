...
export default function StudentGrowthShowcase() {
  ...
  const SECTIONS = [
    { id: 'scores', label: '성적 기록', icon: BarChart2 },
      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        {scoreTrend !== null && (
          <div className="axis-card p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-sm" style={{ color: 'oklch(0.25 0.02 250)' }}>최근 성적 변화</span>
            </div>
        ...
        <div className="axis-card p-4">
          ...
          <div className="rounded-xl px-4 py-3 text-sm" style={{ background: 'oklch(0.95 0.06 260)', color: 'oklch(0.3 0.1 260)' }}>
            성적 탭에서 시험 카드를 클릭하면 IF 채점 분석을 볼 수 있습니다.
          ...
          <div className="space-y-2">
            {allResults.length === 0 && schoolRecords.length === 0 && nationalMocks.length === 0 ? (
              <div className="axis-card p-8 text-center">
                ...
                <div className="text-sm" style={{ color: 'oklch(0.6 0.015 250)' }}>아직 기록된 성적이 없습니다.</div>
              </div>
            ) : (
              <>
